...
namespace Pulumi.SUPAVISOR_NATIVE
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/phillarson-xyz/pulumi-supavisor-native";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.SUPAVISOR_NATIVE.version.txt");
    ...
    internal sealed class SUPAVISOR_NATIVEResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public SUPAVISOR_NATIVEResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
